export default function CateringRoute() {
  return (
    <section className="mx-auto my-16 max-w-4xl px-6 text-dark text-opacity-80">
      ...
      <p className="mb-4">
        ...
        family get-together, we have a catering package to suit your needs.
        Choose from our wide selection of appetizers, entrees, and desserts, all
        crafted with the same care and attention to detail as our restaurant
        menu.
      </p>
      <p className="mb-4">
        Some of our most popular catering dishes include classic Italian
        favorites like Margherita Pizza, Chicken Parmigiana, and Linguine alle
        Vongole. And for those with a sweet tooth, we offer decadent desserts
      ...
      <p className="mb-4">
        ...
        learn more about our catering services and how we can make your next
